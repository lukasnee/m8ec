...
#define LV_ATTRIBUTE_LARGE_RAM_ARRAY __attribute__((section(".lvlg_ram")))
 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(trash80_stealth57)

/** Always set a default font */

#define LV_FONT_DEFAULT &trash80_stealth57
